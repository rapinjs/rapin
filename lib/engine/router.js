...
class Router {
    constructor() {
        ...
        this.app.use(mount(common_2.BASE_URL + 'static', serve(common_2.DIR_STATIC)));
        this.app.use(mount(common_2.BASE_URL + 'stylesheet', serve(common_2.DIR_STYLESHEET)));
    ...
    postRequest(ctx, next, route) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const token = !lodash_1.isUndefined(ctx.req.headers.token) ? ctx.req.headers.token : false;
