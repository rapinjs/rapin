...
class Router {
    ...
    postRequest(ctx, next, route) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            ctx.registry.set('request', new request_2.default(Object.assign(Object.assign({}, ctx.request), { query: ctx.query, cookie: ctx.cookie, session: ctx.session, params: ctx.params, ip: ctx.request.ip })));
            ...
            try {
                ...
                yield this.handleError(e, ctx.registry);
            }
