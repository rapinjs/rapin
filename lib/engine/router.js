...
class Router {
    ...
    preRequest(ctx, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.registry.set('request', new request_2.default(Object.assign(Object.assign({}, ctx.request), { query: ctx.query, cookie: ctx.cookies, session: ctx.session, params: ctx.params, ip: ctx.request.ip })));
            ctx.session;
    ...
    postRequest(ctx, next, route) {
        return __awaiter(this, void 0, void 0, function* () {
            this.registry.set('response', new response_1.default(ctx));
            this.registry.set('request', new request_2.default(Object.assign(Object.assign({}, ctx.request), { query: ctx.query, cookie: ctx.cookie, session: ctx.session, params: ctx.params, ip: ctx.request.ip })));
