...
class Router {
    constructor() {
        ...
        this.app.use((0, koa_cookie_1.default)());
    ...
    start() {
        return __awaiter(this, void 0, void 0, function* () {
            yield (0, plugin_1.pluginEvent)('beforeInitRegistry', {
                app: this.app,
            ...
            logger.end();
            yield (0, plugin_1.pluginEvent)('afterInitRegistry', {
                app: this.app,
                registry: this.registry,
                config: common_2.config,
            });
            const router = new KoaRouter();
            yield (0, plugin_1.pluginEvent)('onBeforeInitRouter', {
                app: this.app,
                registry: this.registry,
                router,
                config: common_2.config,
            ...
            const mapRoutes = (0, request_1.routes)(this.registry);
            logger.end();
            (0, lodash_1.forEach)(mapRoutes, route => {
            ...
            yield (0, plugin_1.pluginEvent)('onAfterInitRouter', {
                app: this.app,
                registry: this.registry,
                router,
                config: common_2.config,
    ...
    initRegistry() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            (0, common_1.initHelpers)(this.registry);
    ...
    preRequest(ctx, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            (0, common_1.initHelpers)(ctx.registry);
            yield (0, plugin_1.pluginEvent)('onBeforeRequest', {
                app: this.app,
    ...
    postRequest(ctx, next, route) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            ctx.registry.set('request', new request_2.default(Object.assign(Object.assign({}, ctx.request), { query: ctx.query, cookie: ctx.cookies, session: ctx.session, params: ctx.params, ip: ctx.request.ip })));
            yield (0, plugin_1.pluginEvent)('onRequest', {
                app: this.app,
                registry: ctx.registry,
                ctx,
                route,
            ...
            try {
                (0, event_1.triggerEvent)('controller/' + route.action, 'before', { data: {} });
                const action = new action_1.default(route.action);
                const output = yield action.execute(ctx.registry);
                (0, event_1.triggerEvent)('controller/' + route.action, 'after', {
                    data: {},
                    output
                });
            }
    ...
    handleError(err, ctx) {
        return __awaiter(this, void 0, void 0, function* () {
            const { registry } = ctx;
            yield (0, plugin_1.pluginEvent)('onError', {
                app: this.app,
                err,
                ctx,
                registry,
            ...
            if (!(0, lodash_1.isUndefined)(registry.get('response'))) {
