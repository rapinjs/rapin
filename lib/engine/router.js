...
class Router {
    ...
    start() {
        return __awaiter(this, void 0, void 0, function* () {
            yield plugin_1.pluginEvent('beforeInitRegistry', { app: this.app });
            yield this.initRegistry();
            yield plugin_1.pluginEvent('afterInitRegistry', { app: this.app, registry: this.registry });
            const router = new KoaRouter();
            yield plugin_1.pluginEvent('onBeforeInitRouter', { app: this.app, registry: this.registry, router });
            ...
            yield plugin_1.pluginEvent('onAfterInitRouter', { app: this.app, registry: this.registry });
    ...
    postRequest(ctx, next, route) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield plugin_1.pluginEvent('onRequest', { app: this.app, registry: this.registry, ctx, route });
    ...
    handleError(err) {
        return __awaiter(this, void 0, void 0, function* () {
            yield plugin_1.pluginEvent('onError', { app: this.app, err, registry: this.registry });
